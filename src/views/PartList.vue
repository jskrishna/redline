<template>
  <div class="part-list">
    <div class="page-header">
      <h1>{{ $route.name }}</h1>
      <div class="add-btn">
        <router-link class="btn custom-btn" class-active="" to="/add-vehicle"
          >Add Vehical</router-link
        >
      </div>
    </div>
          ...
          <td>{{ item.Parts_Value }}</td>
            <td>
              <ul class="action-list">
                <li>
                   <a href="" class="act-icon view-icon" v-b-tooltip.hover title="See Parts">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="25"
                  height="16.256"
                  viewBox="0 0 25 16.256"
                >
                  <g transform="translate(-1 -3)">
                    <g transform="translate(1 3)">
                      <ellipse
                        ...
                        rx="3.5"
                        ry="3"
                        transform="translate(9.138 5)"
                      />
                      <path
                        d="M13.5,3A13.185,13.185,0,0,0,1,11.128a13.185,13.185,0,0,0,12.5,8.128A13.185,13.185,0,0,0,26,11.128,13.185,13.185,0,0,0,13.5,3Zm0,13a5.134,5.134,0,0,1-5.357-4.877A5.134,5.134,0,0,1,13.5,6.251a5.134,5.134,0,0,1,5.357,4.877A5.134,5.134,0,0,1,13.5,16Z"
                  ...
                  <li>
                     <a href="" class="act-icon edit-icon" v-b-tooltip.hover title="Edit">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16.258"
                  height="16.256"
                ...
                >
                  <g transform="translate(-2.468 -2.525)">
                    ...
                    <li>
                      <a href="" class="act-icon add-icon" v-b-tooltip.hover title="Add Vehicle">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16.256"
                  height="16.256"
